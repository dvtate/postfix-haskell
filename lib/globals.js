...
const operators = {
    ...
    'class' : {
        action: (ctx, token) => {
            ...
            const wrapper = (ctx, tok) => {
                ...
                ctx.stack.push(
                    new value.Value(token, value.ValueType.Type,
                        new types.ClassType(token, t.value)));
            };
    ...
    '==' : {
        action: (ctx, token) => {
            ...
            const toBool = b => [globalIds['false'], globalIds['true']][Number(b)];
            ...
            switch (a.type) {
                ...
                case value.ValueType.Data:
                    ...
                    // branch based on stored value
                    // - For tuple recursively iterate through each
