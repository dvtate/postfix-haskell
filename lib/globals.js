...
const funs = {
    ...
    '@' : new value.Value(null, value.ValueType.Fxn, new Fun(
        ...
        new value.Value(null, value.ValueType.Macro, new Macro((ctx, token) => ctx.invoke(ctx.stack.pop()))),
    )),
    ...
    '==' : new value.Value(null, value.ValueType.Fxn, new Fun(
        ...
        new value.Value(null, value.ValueType.Macro, new Macro((ctx, token) => {
            ...
            if (a.type !== b.type)
                return ['invalid syntax'];
            if ((!b.datatype && a.datatype) || !b.datatype.check(a.datatype !== b.datatype))
